...
//Aqui se pone codigo personalizado
const version = "app-compra-v12" 

self.addEventListener('install', e => {
  console.log(`Instalando version ${version}`)
  self.registration.showNotification("Existe una nueva version de la app!",{body: "instala ahora mismo"})
})
